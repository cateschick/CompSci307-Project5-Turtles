...
public class DukeApplicationTest extends ApplicationTest {
    // typical dialog box submit ButtonColorPicker text, perhaps should be a parameter?
    ...
    /**
     * Simulate a click on any kind of ButtonColorPicker
     */
    ...
    /**
     * Simulate a click within a non-ButtonColorPicker node
     */
    ...
    protected void writeInputsToDialog (String ... textInput) {
        ...
        // look up resulting dialog's ButtonColorPicker based on its label
